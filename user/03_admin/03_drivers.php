              ...
              <table class="min-w-full divide-y divide-slate-200 text-left">
                <thead class="bg-slate-50">
                  <tr>
                    ...
                    <th
                      class="px-6 py-4 text-xs font-semibold uppercase tracking-[0.2em] text-slate-500 text-right"
                    >
                      Actions
                    </th>
                  </tr>
                ...
                <tbody class="divide-y divide-slate-200 bg-white">
                  <tr class="hover:bg-slate-50 transition-colors">
                    ...
                    <td
                      class="px-6 py-5 text-sm font-semibold text-emerald-700"
                    >
                      On Route
                    </td>
                    <td class="px-6 py-5 text-sm text-slate-900">BUS 18</td>
                  ...
                  <tr class="hover:bg-slate-50 transition-colors">
                    ...
                    <td class="px-6 py-5 text-sm text-slate-900">BUS 07</td>
                    <td class="px-6 py-5 text-sm text-right">
                      <button
                        class="rounded-full border border-slate-200 bg-slate-50 px-3 py-1 text-xs font-semibold text-slate-700 hover:bg-slate-100"
                      >
                  ...
                  <tr class="hover:bg-slate-50 transition-colors">
                    ...
                    <td class="px-6 py-5 text-sm text-slate-900">BUS 27</td>
                    <td class="px-6 py-5 text-sm text-right">
                      <button
                        class="rounded-full border border-slate-200 bg-slate-50 px-3 py-1 text-xs font-semibold text-slate-700 hover:bg-slate-100"
                      >
              ...
              <div class="grid gap-4 md:grid-cols-2">
                ...
                <div>
                  ...
                  >
                    ...
                    <option>Bocaue → Marilao</option>
                    <option>Marilao → Meycauayan</option>
                    <option>Bocaue → Meycauayan</option>
                  </select>
                </div>
              </div>
              <div class="grid gap-4 md:grid-cols-2">

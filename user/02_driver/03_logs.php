            ...
            <div class="px-8 py-8 space-y-10">
              <div class="grid gap-4 sm:grid-cols-2">
                ...
                >
                  ...
                  <p class="mt-3 text-4xl font-black text-slate-900">2</p>
                  <p class="mt-2 text-sm text-slate-600">
                ...
                >
                  <div>
                    ...
                    <p class="mt-2 text-sm text-slate-700">
                      Current Stop:
                      <span class="font-semibold text-slate-900">Marilao</span>
                    </p>
                  </div>
                  <div
                    class="rounded-full bg-emerald-700/10 px-4 py-2 text-sm font-semibold text-emerald-900"
                  >
                    Currently On Trip • 2 passengers
                  </div>
                </div>
                <div class="mt-6 space-y-4">
                  <div
                    class="rounded-[1.25rem] border border-emerald-200 bg-white p-4 shadow-sm"
                  >
                    <div
                    ...
                    <div class="mt-4 grid gap-4 sm:grid-cols-2">
                      ...
                      >
                        ...
                        <p class="mt-1 text-xs text-slate-500">8:30 AM</p>
                      </div>
                      <div
                        class="rounded-[1rem] border border-slate-200 bg-slate-50 p-4"
                      >
                        <p
                          class="text-xs uppercase tracking-[0.3em] text-slate-500 font-semibold"
                        >
                  ...
                  >
                    ...
                    <div class="mt-4 grid gap-4 sm:grid-cols-2">
                      ...
                      >
                        ...
                        <p class="mt-1 text-xs text-slate-500">8:42 AM</p>
                      </div>
                      <div
                        class="rounded-[1rem] border border-slate-200 bg-slate-50 p-4"
                      >
                      ...
                      >
                        ...
                        <div class="mt-4 grid gap-4 sm:grid-cols-2">
                          ...
                          >
                            ...
                            <p class="mt-1 text-xs text-slate-500">8:00 AM</p>
                          </div>
                          <div
                          ...
                          >
                            ...
                            <p class="mt-1 text-xs text-slate-500">9:05 AM</p>
                          </div>
                        </div>
                      </div>
                      <div
                      ...
                      >
                        ...
                        <div class="mt-4 grid gap-4 sm:grid-cols-2">
                          ...
                          >
                            ...
                            <p class="mt-1 text-xs text-slate-500">8:15 AM</p>
                          </div>
                          <div
                            class="rounded-[1rem] border border-rose-200 bg-rose-50/80 p-4"
                          >
                            ...
                            <p class="mt-1 text-xs text-slate-500">9:18 AM</p>
                          </div>
                        </div>
                      </div>
                    </div>
